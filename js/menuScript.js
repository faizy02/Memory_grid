...
function setStats(playerStats) {
    $('.stats-block > span:nth-child(2)').html(playerStats.username);
    $('.stats-block > span:nth-child(5) > b').html(playerStats.score);
}
function getStats(playerStats) {
    playerStats.username = localStorage.getItem('username');
    playerStats.score = localStorage.getItem('score');
}
function play() {
